...
function RestBar({ timer, onSkip, onAdd }) {
  ...
  return (
    <div style={{position:"fixed",top:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:520,zIndex:1000,background:T.bg,borderBottom:`1px solid ${(urgent||finished)?T.accent:T.hairlineMid}`,padding:"12px 20px 10px",boxSizing:"border-box"}}>
            ...
            <button key={sess.key}
              ...
              <div style={{display:"flex",alignItems:"flex-start",gap:18}}>
                <div style={{flexShrink:0,minWidth:56}}>
                  ...
                  <Display size={54} weight={900} style={{color:(suggested||isActive)?T.accent:T.text,letterSpacing:"-0.04em"}}>{sess.label}</Display>
                </div>
